...
import boto3
from langchain_community.embeddings import BedrockEmbeddings, OpenAIEmbeddings, HuggingFaceEmbeddings, CohereEmbeddings
...
class EmbeddingService:
    ...
    def __init__(self):
        ...
        self.embedding_dimensions = {
            ...
            EmbeddingProvider.BEDROCK: {
                ...
                "amazon.titan-embed-g1-text-02:0": 1536,
    ...
    def get_embedding_dimension(self, provider: str, model: str) -> int:
        ...
        try:
            # 查找预定义的维度
            return self.embedding_dimensions[provider][model]
        except KeyError:
            # 如果没有预定义，使用默认值
            print(f"Embedding dimension not found for {provider}:{model}, using default 1536")
            return 1536
